...
const plantsData = [
    { id: 1, name: "Rosa", scientificName: "Rosa spp.", description: "Flor símbolo do amor e da beleza, com variedades em diversas cores e fragrâncias.", image: "imagens/rosavermelha.jpg", category: "ornamental", size: "medio", light: "sol-pleno", water: "moderada", difficulty: "moderado", tags: ["Ornamental", "Perfumada"], popularity: 95 },
    { id: 2, name: "Girassol", scientificName: "Helianthus annuus", description: "Planta que segue o movimento do sol, conhecida por suas sementes nutritivas.", image: "imagens/girassol.webp", category: "alimenticia", size: "grande", light: "sol-pleno", water: "moderada", difficulty: "facil", tags: ["Alimentícia", "Ornamental"], popularity: 88 },
    { id: 3, name: "Lavanda", scientificName: "Lavandula angustifolia", description: "Planta aromática conhecida por suas propriedades relaxantes e medicinais.", image: "imagens/lavanda.webp", category: "medicinal", size: "pequeno", light: "sol-pleno", water: "baixa", difficulty: "facil", tags: ["Medicinal", "Aromática"], popularity: 92 },
    { id: 4, name: "Orquídea", scientificName: "Orchidaceae", description: "Família de plantas com flores exóticas e elegantes, muito apreciadas na decoração.", image: "imagens/orquideaazul.webp", category: "ornamental", size: "pequeno", light: "meia-sombra", water: "moderada", difficulty: "dificil", tags: ["Ornamental", "Exótica"], popularity: 85 },
    { id: 5, name: "Ipê Amarelo", scientificName: "Handroanthus albus", description: "Árvore brasileira que floresce no inverno, símbolo da chegada da primavera.", image: "imagens/ipêamarelin.webp", category: "nativa", size: "grande", light: "sol-pleno", water: "moderada", difficulty: "moderado", tags: ["Nativa", "Ornamental"], popularity: 78 },
    { id: 6, name: "Manjericão", scientificName: "Ocimum basilicum", description: "Erva aromática amplamente utilizada na culinária e medicina tradicional.", image: "imagens/manjericao.webp", category: "aromatica", size: "pequeno", light: "sol-pleno", water: "moderada", difficulty: "facil", tags: ["Aromática", "Culinária"], popularity: 90 },
    { id: 7, name: "Samambaia", scientificName: "Nephrolepis exaltata", description: "Planta ornamental ideal para ambientes internos e sombreados.", image: "imagens/samambaia.webp", category: "ornamental", size: "medio", light: "sombra", water: "alta", difficulty: "moderado", tags: ["Ornamental", "Interior"], popularity: 82 },
    { id: 8, name: "Aloe Vera", scientificName: "Aloe barbadensis", description: "Planta suculenta conhecida por suas propriedades medicinais e cosméticas.", image: "imagens/aloevera1.webp", category: "medicinal", size: "pequeno", light: "sol-pleno", water: "baixa", difficulty: "facil", tags: ["Medicinal", "Suculenta"], popularity: 87 },
    { id: 9, name: "Cacto", scientificName: "Cactaceae", description: "Planta suculenta adaptada a ambientes secos, com espinhos e formas variadas.", image: "imagens/cacto.webp", category: "ornamental", size: "pequeno", light: "sol-pleno", water: "baixa", difficulty: "facil", tags: ["Suculenta", "Exótica"], popularity: 80 },
    { id: 10, name: "Hortelã", scientificName: "Mentha spicata", description: "Erva aromática refrescante, usada em chás, bebidas e pratos culinários.", image: "imagens/hortela.webp", category: "aromatica", size: "pequeno", light: "meia-sombra", water: "alta", difficulty: "facil", tags: ["Aromática", "Culinária", "Medicinal"], popularity: 89 },
    { id: 11, name: "Tomate Cereja", scientificName: "Solanum lycopersicum var. cerasiforme", description: "Pequeno fruto saboroso, ideal para cultivo em vasos e usado em saladas e molhos.", image: "imagens/tomatecereja.webp", category: "alimenticia", size: "medio", light: "sol-pleno", water: "moderada", difficulty: "moderado", tags: ["Alimentícia", "Horta"], popularity: 86 },
    { id: 12, name: "Jiboia", scientificName: "Epipremnum aureum", description: "Planta trepadeira muito resistente, ideal para iniciantes e ambientes internos.", image: "imagens/jiboia.jpg", category: "ornamental", size: "medio", light: "meia-sombra", water: "moderada", difficulty: "facil", tags: ["Interior", "Purificadora"], popularity: 93 },
    { id: 13, name: "Pitangueira", scientificName: "Eugenia uniflora", description: "Árvore frutífera nativa do Brasil, produz frutos saborosos e atrai pássaros.", image: "imagens/PITANGAS.jpg", category: "nativa", size: "grande", light: "sol-pleno", water: "moderada", difficulty: "facil", tags: ["Nativa", "Frutífera"], popularity: 75 },
    { id: 14, name: "Camomila", scientificName: "Matricaria chamomilla", description: "Planta medicinal com flores delicadas, usada para fazer chás calmantes.", image: "imagens/camomila.webp", category: "medicinal", size: "pequeno", light: "sol-pleno", water: "moderada", difficulty: "facil", tags: ["Medicinal", "Chá"], popularity: 84 },
    { id: 15, name: "Zamioculca", scientificName: "Zamioculcas zamiifolia", description: "Planta extremamente resistente à falta de água e luz, perfeita para escritórios.", image: "imagens/zamio.jpeg", category: "ornamental", size: "medio", light: "sombra", water: "baixa", difficulty: "facil", tags: ["Interior", "Resistente"], popularity: 91 },
    { id: 16, name: "Alecrim", scientificName: "Rosmarinus officinalis", description: "Arbusto aromático usado como tempero e em óleos essenciais. Estimula a memória.", image: "imagens/alecrim.webp", category: "aromatica", size: "medio", light: "sol-pleno", water: "baixa", difficulty: "facil", tags: ["Aromática", "Culinária"], popularity: 88 },
    { id: 17, name: "Bromélia", scientificName: "Bromeliaceae", description: "Planta tropical com folhas coloridas e uma inflorescência exótica no centro.", image: "imagens/bromelia.webp", category: "ornamental", size: "pequeno", light: "meia-sombra", water: "moderada", difficulty: "moderado", tags: ["Tropical", "Exótica"], popularity: 79 },
    { id: 18, name: "Jabuticabeira", scientificName: "Plinia cauliflora", description: "Árvore frutífera nativa do Brasil, cujos frutos crescem diretamente no tronco.", image: "imagens/jabuticaba.webp", category: "nativa", size: "grande", light: "sol-pleno", water: "alta", difficulty: "moderado", tags: ["Nativa", "Frutífera"], popularity: 81 },
    { id: 19, name: "Costela-de-Adão", scientificName: "Monstera deliciosa", description: "Planta com folhas grandes e recortadas, muito popular na decoração de interiores.", image: "imagens/costeladeadao.jpg", category: "ornamental", size: "grande", light: "meia-sombra", water: "moderada", difficulty: "facil", tags: ["Interior", "Tropical"], popularity: 94 },
    { id: 20, name: "Pimenta", scientificName: "Capsicum spp.", description: "Planta que produz frutos picantes, usada como tempero em todo o mundo.", image: "imagens/pimenta.webp", category: "alimenticia", size: "pequeno", light: "sol-pleno", water: "moderada", difficulty: "moderado", tags: ["Alimentícia", "Horta", "Picante"], popularity: 83 }
];
